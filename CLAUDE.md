...
## Active Technologies
- Python 3.11 + FastAPI 0.115, Pydantic 2.10, redis[asyncio] ^5.0 (already installed) (013-extraction-status-polling)
- Redis (cache only — no new DB tables, no Alembic migration) (013-extraction-status-polling)
