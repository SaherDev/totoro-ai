...
## Active Technologies
- Python 3.11 + FastAPI 0.115, SQLAlchemy 2.0 async, Pydantic 2.10, asyncpg, Alembic (008-taste-model)
- PostgreSQL — modifying `taste_model` table, creating `interaction_log` table (008-taste-model)
