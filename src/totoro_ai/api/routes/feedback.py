...
from totoro_ai.core.events.events import RecommendationAccepted, RecommendationRejected
...
async def post_feedback(
    ...
    Called by NestJS (product repo) after user taps feedback affordance in frontend.
    Dispatches event to update taste model asynchronously.
    ...
    Behavior:
        ...
        - Handler failures are logged and traced via Langfuse, never surfaced to user

    Notes:
        - recommendation_id is stored in interaction_log.context for traceability
